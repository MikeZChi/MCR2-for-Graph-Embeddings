...
if __name__ == '__main__': 
    ...
    for i in range(len(datasets_names)):
        ...
        dataloader = DataLoader(dataset, batch_size=batch_size, num_workers=0) #args.num_workers)
        ...
        for epoch in range(1, epochs + 1):
            ...
            for data in dataloader:
                ...
                for ii in range(local_batch_size):
                    batch_idx = batch_idx + [ii] * args.aug_num   #* args.num_latent_factors
